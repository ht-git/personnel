                ...
                <div class="layui-input-inline">
                    <select id="job_id" name="job_id" class="valid" >
                        <c:forEach items="${requestScope.job_list}" var="line" varStatus="stat">
                            <option value="${line.id}" <c:if test="${employee.job.name == line.name }">selected</c:if>>${line.name}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
                ...
                <div class="layui-input-inline">
                    <select id="dept_id" name="dept_id" class="valid">
                        <c:forEach items="${requestScope.dept_list}" var="line" varStatus="stat">
                            <option value="${line.id}" <c:if test="${employee.dept.name == line.name }">selected</c:if>>${line.name}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
